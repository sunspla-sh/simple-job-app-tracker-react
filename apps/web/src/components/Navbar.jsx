  ...
  return (
    <nav className='navbar'>
      <div className='navbar_header'>
        {/* MOBILE HEADER WITH LOGO AND DROPDOWN BUTTON */}
        ...
        <div className='navbar_header-desktop'>
          <div className='navbar_header-desktop_logo-container'>
            <Link
              to='/'
            >
              <svg
          ...
          <div className='navbar_header-desktop_link-container'>
            {isLoggedIn ? (
            <>
              {loggedInNavigation.map(element => (
                <NavLink
                  key={element.to}
                  to={element.to}
                  className={({ isActive }) => isActive ? 'navbar_header-desktop_link active' : 'navbar_header-desktop_link'}
                >
                  {element.name}
                </NavLink>
              ))}
              <button
                className='navbar_header-desktop_logout'
                onClick={logOutUser}
              >
                Log Out
              </button>
